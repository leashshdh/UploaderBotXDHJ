...
"""
    ...
    FORMAT_SELECTION = (
        "Choose The Size: <a href='{}'>File size might be approximate</a>.Click On Down Button for select size.\n Warning After Select Size Dont Send Anything & Kindly Wait.It Will take time according to size"
        ""
    )
    ...
    UPLOAD_START = " 📤UploadinG📤 \nPlease Wait 1-2 Min According to Size"
    RCHD_BOT_API_LIMIT = (
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = (
        "Suport : https://t.me/LegendBot_AI\n Thanks To @LegendBoy_XD ♥️"
    )
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nSupport : https://t.me/LegendBot_AI\nUploaded in {} seconds."
    NOT_AUTH_USER_TEXT = "Please /upgrade your subscription."
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/pw_upload_linkbot'>@LegendBot_AI</a>"
...
"""
    HELP_USER = """Hii I am <b>bot</b> and I can perform many tasks.

1.) Send url (Link|New Name with Extension)
2.) Wait For Some Time.
3.) Select the button.
   SVideo - Give File as video(Use This Button To Get Fast Video)
   ...
   Support : https://t.me/LegendBot_AI \n\n\\Thanks To @LegendBoy_XD"""
    ...
    REPLY_TO_DOC_FOR_RENAME_FILE = (
        "Reply to a Telegram media to /ren with custom thumbnail support"
    )
    ...
    FF_MPEG_RO_BOT_RE_SURRECT_ED = (
        """Syntax: /trim HH:MM:SS for screenshot of that specific time."""
    )
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "Join : @LegendBot_AI \nThanks to @LegendBoy_XD. "
    ...
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/pw_upload_linkbot'>@LegendBot_AI</a>"
